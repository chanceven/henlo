...
class PawtnerFAQScreen extends StatefulWidget {
  const PawtnerFAQScreen({super.key});

  @override
  State<PawtnerFAQScreen> createState() => _PawtnerFAQScreenState();
}

class _PawtnerFAQScreenState extends State<PawtnerFAQScreen> {
  ...
  Future<void> _fetchFAQs() async {
    ...
    try {
      final List<dynamic> response =
          await supabase.from('pawtner_faqs').select('*').order('created_at');
