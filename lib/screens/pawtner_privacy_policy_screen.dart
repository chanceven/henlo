...
class PawtnerPrivacyPolicyScreen extends StatelessWidget {
  const PawtnerPrivacyPolicyScreen({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildBody(
                'We respect your privacy and are committed to protecting your personal information on Pawtner.'),
            _buildHeading('Information We Collect'),
            _buildBody(
                '- Personal information you provide (name, email, profile, pet info)\n- Usage data (how you use the Pawtner app)'),
            ...
            _buildBody(
                'If you have questions about this Privacy Policy, contact us at support@pawtner.com'),
          ],
        ),
      ),
    );
